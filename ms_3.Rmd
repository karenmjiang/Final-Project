...
## Current vs. Initial Tracks

```{r}
tracks <- aco %>%
  select(ACO_ID, Agree_Type, Current_Track_1, Current_Track_1_Plus, Current_Track_2, Current_Track_3, Initial_Track_1, Initial_Track_1_Plus, Initial_Track_2, Initial_Track_3) %>%
